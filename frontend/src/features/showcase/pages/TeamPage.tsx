...
const teamMembers: TeamMember[] = [
  ...
  { id: 'adriana', name: "Adriana Pires", role: "TC", email: "adrianapires@ua.pt", targetContributions: "Hardware lead & BLE protocol & 3D CAD", group: 'carebox', subGroup: 'TC', image: "/team/adriana.png" },
  ...
  { id: 'joana', name: "Joana Costa", role: "ENG", email: "joanavcosta@ua.pt", targetContributions: "Mechanical design", group: 'carebox', subGroup: 'ENG', image: "/team/joana.png" },
    ...
    <div className="flex items-center gap-4">
      ...
      <div className="flex-1 min-w-0">
         ...
         <div className="flex gap-3 mt-3 opacity-60 hover:opacity-100 transition-opacity">
            <a href={`mailto:${member.email}`} className="text-text-muted hover:text-text-main" aria-label={`Email ${member.name}`}><Mail size={12} /></a>
         </div>
      </div>
    </div>
  </motion.div>
